...
ArrayList<Trabajo>Trabajo=new ArrayList<Trabajo>();
    ...
    Trabajo.add(new Trabajo((txtnom.getText()),txttp.getText(),Integer.parseInt(txtce.getText())));
    ...
    public void mostrar(){
     ...
     Iterator it2 = Trabajo.iterator(); 
    while ( it2.hasNext() ) { 
   Trabajo p = (Trabajo)it2.next();
   
    System.out.println(p.getNombre()+" "+p.getTipo()+" "+p.getCc());
    i++;
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        System.out.println("Total de visitantes:"+i);
